...
def plot_mesh(
    ...
    y: torch.Tensor,
    z: torch.Tensor,
    labeled_dataset: DummyPositiveNegativeDataset | None = None,
    unlabeled_dataset: DummyPositiveNegativeDataset | None = None,
    path: str | None = None,
) -> None:
    if labeled_dataset is None:
        labeled_positive_inputs = None
        labeled_negative_inputs = None
    else:
        labeled_positive_inputs = []
        labeled_negative_inputs = []
    ...
    axis.pcolormesh(x, y, z, alpha=0.7, norm=norm, cmap="bwr")
